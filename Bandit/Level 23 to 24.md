...
Para poder hacer este reto, implementamos un for que ejecute la contraseña pero con pines diferente solo con un comando. **grep -V Wrong** lo que hace es que solo muestra la linea que fue exitosa, no muestra las lineas que utilizaron las variables del ciclo fallidas.****
